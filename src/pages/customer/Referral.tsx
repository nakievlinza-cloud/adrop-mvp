...
export function CustomerReferral() {
  ...
  const benefits = [
    { icon: DollarSign, title: "10% от первых транзакций", desc: "Зарабатывайте с каждого приглашённого заказчика или креатора" },
    ...
    <div className="w-full px-6 sm:px-8 lg:px-12 2xl:px-16 py-8">
      <div className="text-center mb-12">
        <div className="w-16 h-16 bg-clip-primary/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
          <Gift className="w-8 h-8 text-clip-primary" />
        </div>
        <h1 className="text-3xl font-display font-bold mb-2">Реферальная программа</h1>
        <p className="text-foreground/60">
          Приглашайте партнёров и зарабатывайте вместе с ними
        </p>
      </div>
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-clip-primary/10 to-ugc-primary/10 border border-white/10 rounded-2xl p-8 mb-8"
      >
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex-1">
            <h2 className="text-xl font-bold mb-2">Ваша реферальная ссылка</h2>
            <p className="text-sm text-foreground/60">
              Делитесь ссылкой с партнёрами и получайте 10% от их первых транзакций
            </p>
          </div>
          <div className="w-full md:w-auto">
            <div className="flex items-center gap-2 bg-background border border-white/10 rounded-xl p-2">
              ...
              <button
                onClick={handleCopy}
                className="h-10 px-4 bg-clip-primary hover:bg-clip-primary/90 text-white rounded-lg font-medium transition-all flex items-center gap-2 flex-shrink-0"
              >
                {copied ? (
                  <>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {benefits.map((benefit, index) => (
            ...
            >
              <div className="w-12 h-12 bg-clip-primary/10 rounded-xl flex items-center justify-center mb-4">
                <benefit.icon className="w-6 h-6 text-clip-primary" />
              </div>
      ...
      <div className="bg-card border border-white/10 rounded-2xl p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            <div className="w-12 h-12 bg-clip-primary/10 rounded-xl flex items-center justify-center mx-auto mb-4">
              <Share2 className="w-6 h-6 text-clip-primary" />
            </div>
            <h3 className="font-bold mb-2">1. Поделитесь ссылкой</h3>
            <p className="text-sm text-foreground/60">
              Отправьте реферальную ссылку партнёрам или разместите её в социальных сетях
            </p>
          </div>
          <div className="text-center">
            <div className="w-12 h-12 bg-clip-primary/10 rounded-xl flex items-center justify-center mx-auto mb-4">
              <Users className="w-6 h-6 text-clip-primary" />
            </div>
            <h3 className="font-bold mb-2">2. Партнёры регистрируются</h3>
            <p className="text-sm text-foreground/60">
              Привлечённые креаторы и заказчики регистрируются по вашей ссылке
            </p>
          </div>
          <div className="text-center">
            <div className="w-12 h-12 bg-clip-primary/10 rounded-xl flex items-center justify-center mx-auto mb-4">
              <DollarSign className="w-6 h-6 text-clip-primary" />
            </div>
